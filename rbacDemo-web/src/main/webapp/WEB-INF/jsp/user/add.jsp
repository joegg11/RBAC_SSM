			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form role="form">
				  ...
				  <button id="insertBtn" type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 完成</button>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#insertBtn").click(function(){
			    	...
			    	if (loginacct == ""){
			    		layer.msg("登陆账号不能为空", {time:2000, icon:5, shift:1}, function(){
			    	...
			    	/* if (username == ""){
			    		layer.msg("用户名不能为空", {time:2000, icon:5, shift:1}, function(){
			    	...
			    	if (email == ""){
			    		layer.msg("用户邮箱", {time:2000, icon:5, shift:1}, function(){
			    	...
			    	$.ajax({
			    		...
			    		success : function(result){
			    			...
			    			if(result.success){
			    				layer.msg("用户信息保存成功", {time:1000, icon:6, shift:1}, function(){
		                    		window.location.href = "${APP_PATH}/user/index";
		                    	});	
			    			}else{
			    				layer.msg("用户信息保存失败", {time:2000, icon:5, shift:1}, function(){
